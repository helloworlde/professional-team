...
public class ProTeamProgressBarUi extends BasicProgressBarUI {
    private static final float[] FRACTIONS = new float[]{0.5f, 1f};

    private static final Color[] COLORS = new Color[]{JBColor.WHITE, JBColor.WHITE};
    ...
    public static ComponentUI createUI(JComponent c) {
        ...
        return new ProTeamProgressBarUi();
    }
    ...
    protected void paintIndeterminate(Graphics g, JComponent c) {
        ...
        Icon scaledIcon = velocity > 0 ? ((ScalableIcon) ProTeamIcons.PRO_TEAM_ICON) : ((ScalableIcon) ProTeamIcons.PRO_TEAM_RE_ICON);
        g2d.draw(new RoundRectangle2D.Float(1f, 1f, w - 3f, h - 3f, JBUIScale.scale(8f), JBUIScale.scale(8f)));
        scaledIcon.paintIcon(progressBar, g2d, offset2 - JBUI.scale(10), -JBUI.scale(2));
    ...
    protected void paintDeterminate(Graphics g, JComponent c) {
        ...
        ProTeamIcons.PRO_TEAM_ICON.paintIcon(progressBar, g2d, amountFull - JBUI.scale(10), -JBUI.scale(2));
